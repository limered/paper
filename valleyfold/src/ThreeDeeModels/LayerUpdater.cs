...
///
/// Rule per ADR-0003 (which supersedes ADR-0002 §"Layer-update rule on fold"):
/// for each face <c>f</c> in the moving set, the new layer is
...
/// 180° rotation around a horizontal axis flips up/down.
///
...
{
    /// <summary>
    /// Applies the ADR-0003 layer-update rule. If no stationary face overlaps

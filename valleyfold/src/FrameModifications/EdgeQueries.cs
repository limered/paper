...
public static class EdgeQueries
{
    ...
    public static List<Edge> NearestEdgesToPoint3d(Frame3D frame,  Vector3 point)
    {
        var nearestEdges = new List<Edge>();
        for (var i = 0; i < frame.Edges.Count; i++)
        {
    ...
    public static (Vector2, Edge) NearestPointOnEdgeToPoint(
        Frame frame, 
        Vector2 point, 
        List<Edge> edges)
    {
    ...
    public static (Vector3, Edge) NearestPointOnEdgeToPoint(
        Frame3D frame, 
        Vector3 point, 
        List<Edge> edges)
    {
    ...
    public static Vector3 NearestPointOnEdgeTo(Frame3D frame, Vector3 point, Edge edge)
    {
        var start = frame.Vertices[edge.Vertices[0]].Coord;
        var end = frame.Vertices[edge.Vertices[1]].Coord;
        var startToPoint = point - start;
